...
namespace DurableFunction.AsyncHttpAPI.Client
{
    ...
    public static class GetStatus
    {
        ...
        [FunctionName(AppConstants.GetStatus)]
                                                    ...
                                                    ILogger logger)
        {
            ...
            if (status != null)
            {
                ...
                if (status.RuntimeStatus == OrchestrationRuntimeStatus.Running || status.RuntimeStatus == OrchestrationRuntimeStatus.Pending)
                {
                    ...
                    req.HttpContext.Response.Headers.Add("retry-after", AppConstants.RetryTiming); // To inform the client how long to wait before checking the status. 
                    return response;
                }
